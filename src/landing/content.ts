...
export const nav = {
  links: navLinks,
  login: { label: "시작하기", href: "/login" } satisfies NavLink,
};
...
export const faqs = [
  {
    ...
    a: "실전 모의고사는 제한 시간과 실제 시험과 유사한 화면에서 회차 전체를 응시하는 서비스예요.\n모의고사 문제 연습은 시간 제한 없이 원하는 출판사와 회차의 문제를 풀 수 있어요.",
  },
  {
    q: "문제 데이터셋을 신뢰해도 괜찮을까요?",
    a: "출판사 모의고사의 정답표를 기준으로 문제 데이터를 구성하고, 등록 전 검수 과정을 거치고 있어요.\n정답과 해설의 오류가 확인되면 바로 수정해 학습에 불편이 없도록 관리하고 있어요.",
  },
  {
    q: "실제 SKCT 유경험자에게 어떤 피드백을 받았나요?",
    a: "실제 시험과 최대한 유사한 환경을 구현하기 위해 화면 구성과 도구, 지문 등에 대한 피드백을 받았어요.\n유형별 문제의 풀이 팁도 SKCT 유경험자의 의견을 바탕으로 구성했어요.",
  },
  {
    q: "어떤 목적으로 만드셨나요?",
    a: "SKALA 구성원이 흩어진 문제와 학습 기록을 한곳에서 관리하며\n효율적으로 SKCT를 준비할 수 있도록 만들었어요.\n준비 방법을 모르거나 점수가 잘 오르지 않는 분들이 자신의 상황을 직관적으로 파악하고,\n현실적인 성적 향상 방법을 고민하는 시간을 줄이는 것이 목표예요.",
  },
];
